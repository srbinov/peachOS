...
importMap = [
    ...
    [ "from './iconGeometry.js'", "const { matchIconForApp, lampTargetFromIcon, separatorOverlayStyle, separatorOverlaySize } = Me.imports.iconGeometry;" ],
    [ "from './iconMetrics.js'", "const { iconSizeFromScale, iconSpacedSize, extraIconsVisible } = Me.imports.iconMetrics;" ],
    [ "from './liquidGlass.js'", "const { buildDockBackgroundStyle } = Me.imports.liquidGlass;" ],
